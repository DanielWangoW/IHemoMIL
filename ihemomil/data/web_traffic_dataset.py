"""
The WebTrafficDataset class has the following https://github.com/JAEarly/MILTimeSeriesClassification (under Apache 2.0 License)
...
from ihemomil.data.web_traffic_generation import _create_week_with_seasonality

logger = logging.getLogger("IHD_MIL.WebTrafficDataset")
